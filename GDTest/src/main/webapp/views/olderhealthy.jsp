...
<script type="text/javascript" src="/GDTest/js/olderhealthy.js"></script>
...
<body>
		...
		<div id="div3">
			<a href="/GDTest/views/first.jsp">首页</a><br>
			<input type="" value="" size="1"/><td href="/GDTest/views/first.jsp">当前功能:健康档案管理》老年人健康档案</td>
			<center>
			<h3>老年人健康档案</h3>
