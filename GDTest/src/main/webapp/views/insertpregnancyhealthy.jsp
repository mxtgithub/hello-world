...
<script type="text/javascript" src="/GDTest/js/insertPregnancyHealthyPage.js"></script>
</head>
<body>
<center><a href="/GDTest/views/pregnancyhealthy.jsp">返回</a><h3 style="margin-top: 80px;">新增孕产妇健康档案</h3>
	<table>
			<tr>
				<td>用户名</td>
